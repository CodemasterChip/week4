...
var RandoCard = function(min, max) {
  ...
  $(function() {
    $(".deal").on("click", function(event) {
      ...
      var c1 = window.getDeck()[RandoCard(0,51)]
      var c2 = window.getDeck()[RandoCard(0,51)]
      var c3 = window.getDeck()[RandoCard(0,51)]
      var c4 = window.getDeck()[RandoCard(0,51)]
      var c5 = window.getDeck()[RandoCard(0,51)]
